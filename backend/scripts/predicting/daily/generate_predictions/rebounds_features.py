from scripts.utils.etl import extract, load, transform_prediction_stat, create_spark_session
...
output_table = "predicting.player_reb"
...
def handler():
    ...
    SELECT
        ...
        dreb::double precision AS opp_drb_per_game,
    ...
    SELECT
        ...
        oreb::double precision as orb_per_game,
        dreb::double precision as drb_per_game,
    ...
    stats_to_average = ["reb", "oreb", "min", "dreb", "blk"]
