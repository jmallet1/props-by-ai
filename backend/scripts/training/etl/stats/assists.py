...
output_table = "training.player_ast"
...
# Calculate rolling averages for each desired column
columns_to_average = ["pts", "ast", "min", "fga", "fta"]
data_transformed = transform_training_stat(player_df=player_df, opp_df=opp_df, team_df=team_df, columns_to_average=columns_to_average, target_col="ast")
