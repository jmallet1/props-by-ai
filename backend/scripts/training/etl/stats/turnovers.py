...
output_table = "training.player_tov"
...
if __name__ == "__main__":
    ...
    columns_to_average = ["min", "fgm", "fga", "fg3a", "pf", "tov", "ast", "reb"]
    data_transformed = transform_training_stat(player_df=player_df, opp_df=opp_df, team_df=team_df, columns_to_average=columns_to_average, target_col="tov")
