...
db_url = "jdbc:postgresql://postgres:5432/props_by_ai_db"
...
def truncate(table: str):
    ...
    engine = create_engine(f"postgresql+psycopg2://{db_properties['user']}:{db_properties['password']}@postgres:5432/props_by_ai_db")
