        ...
        <div className='DonutContainer'>
            ...
            <div className='ModernDonut'>
                <div className='DonutTextContainer'>
                    ...
                    <div className='NumberContainer'>
                        <h1 className='Number'>{statPerGame === '-1.0' ? 'N/A' : statPerGame}</h1>
                    </div>
                </div>
                <div className='DonutGraph'>
                    <DonutChart overData={statPerGame === '-1.0' ? 1 : statPerGame} underData={statPerGame === 0 && prediction === 0 ? 1 : statPerGame === '-1.0' ? 1 : prediction}/>
                </div>
